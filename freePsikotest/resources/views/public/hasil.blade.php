...
@section('content')
    <div class="position-relative p-4 p-md-5 text-center text-muted bg-body rounded-5"
        ...
        <div class="container my-4">
            @foreach ($results as $kategori => $nilai)
                <div class="mb-4">
                    <div class="row align-items-center">
                        <div class="col-md-2 col-4 text-start fw-semibold">{{ $kategori }}: <i>{{ $nilai[1] }}</i></div>
                        <div class="col-md-10 col-8">
                            <div class="custom-progress">
                                <div class="custom-progress-bar" style="width: {{ $nilai[0] }}%;">{{ $nilai[0] }}%</div>
                            </div>
                        </div>
                    </div>
                </div>
