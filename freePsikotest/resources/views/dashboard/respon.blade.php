...
@section('content')
    ...
    <a href="{{ route('home') }}" class="button text-center mb-3" style="z-index: 1; max-width: fit-content;">
        Tambah Respons
    </a>
                ...
                <tbody>
                    @foreach ($data as $i => $item)
                        <tr>
                            ...
                            <td class="text-center">{{ $item->Depression ?? 0 }}</td>
                            <td class="text-center">{{ $item->Anxiety ?? 0 }}</td>
                            <td class="text-center">{{ $item->Stress ?? 0 }}</td>
                            <td class="text-center">
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    <a href="{{ route('responDetail', ['id' => $item->id_responden]) }}">
